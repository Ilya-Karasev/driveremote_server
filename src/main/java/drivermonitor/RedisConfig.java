...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(ObjectMapper objectMapper) {
        ...
        return RedisCacheManager.builder(redisConnectionFactory())
                ...
                .withCacheConfiguration("userById", cacheConfig)
                .withCacheConfiguration("usersById", cacheConfig)
                .withCacheConfiguration("results", cacheConfig)
                .withCacheConfiguration("resultsByUserId", cacheConfig)
                .withCacheConfiguration("lastResultsUserId", cacheConfig)
